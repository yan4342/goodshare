...
echo 2. Starting Gateway Service (8080) [Nacos: 18848]...
...
REM start "Recommendation Service" cmd /k "cd recommendation-service && pip install -r requirements.txt && python app.py"
echo Skipped local Recommendation Service (Running in Docker)
